...
static enum sha_algos opt_algo = ALGO_DROP;
int opt_n_threads = 0;
int opt_affinity = -1;
int opt_priority = 0;
...
int main(int argc, char *argv[])
{
	...
	printf("*** ccminer " PACKAGE_VERSION " DropLP edition for nVidia GPUs ***\n");
#ifdef _MSC_VER
	...
	printf("  Includes some of the work of tpruvot, djm34, sp, tsiv and klausT.\n");
	printf("  DropLP support by nscrypto.\n\n");
	printf("DROP donation address: DVRLyv6nWZiWdGGEqrPVmRR4An1e8acM6b (nscrypto)\n\n");
